...
namespace Dunjun
{
	...
	void Mesh::draw()
	{
		...
		glEnableVertexAttribArray((u32)AttribLocation::Color); // enables attribute array[1] a_color ''
		glEnableVertexAttribArray((u32)AttribLocation::TexCoord); // enable attribute [2] a_texCoord
		...
		glDisableVertexAttribArray((u32)AttribLocation::Color); // enables attribute array[1] a_color ''
		glDisableVertexAttribArray((u32)AttribLocation::TexCoord); // enable attribute [2] a_texCoord
